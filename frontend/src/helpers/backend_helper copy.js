...
export const deleteElectionAttendee = (electionAttendee) => api.delete(url.DELETE_ELECTION_ATTENDEE, { headers: { electionAttendee } });
...
export const updateCategory = (category) => api.put(url.UPDATE_CATEGORY, category);
