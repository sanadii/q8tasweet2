...
export const GET_ELECTION_CANDIDATE_DETAILS =
  "/elections/getElectionCandidateDetails";
export const GET_ELECTION_CANDIDATE_COUNT =
  "/elections/getElectionCandidateCount";
