...
import ElectorSearchForm from "./ElectorAttendanceForm";
import ElectorSearchDisplay from "./ElectorAttendanceDisplay";

export const ElectorAttendance = ({ schema }) => {
  ...
  const currentCampaignMemberCommittee = currentCampaignMember
    ? currentCampaignMember.committee.name
    : '';
          ...
          <Card>
            <CardHeader>
              <Row className="mb-2">
                ...
                <span>{currentCampaignMemberCommittee}</span>
              </Row>
            </CardHeader>
...
export default ElectorAttendance;
