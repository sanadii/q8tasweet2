...
const ElectionList = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      category: (election && election.category) || 0,
      subCategory: (election && election.subCategory) || 0,
  ...
  const handleElectionClick = useCallback(
    (arg) => {
      ...
      setElection({
        ...
        // categoryName: election.categoryName,
        subCategory: election.subCategory,
        // subCategoryName: election.subCategoryName,
