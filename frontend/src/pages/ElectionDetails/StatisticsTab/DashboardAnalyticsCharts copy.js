...
const ElectorsOverviewCharts = ({ electorsByFamiliesArea,resultsToDisplay, resultByGender, dataSeries }) => {
    ...
    const series = resultByGender ? resultsByGender : resultTotal;
    const dataColors = resultByGender ? ['var(--vz-info)', 'var(--vz-pink)'] : ['var(--vz-success)'];
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr"
                options={options}
                series={series} // Ensure series data is correctly structured
                type="bar"
                height="374"
