                                    ...
                                    <Row>
                                        ...
                                        <Col lg={3} sm={6}>
                                            <div>
                                                ...
                                                <h5 className="fs-15 mb-0">{campaign.duedate}</h5>
                                            </div>
                                        </Col>
                                        <Col lg={3} sm={6}>
                                            <div>
                                        ...
                                        <Col lg={3} sm={6}>
                                            <div>
                                                ...
                                                <div className="badge bg-danger fs-12">{campaign.priority}</div>
                                            </div>
                                        </Col>
                                        <Col lg={3} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Status :</p>
                                                <div className="badge bg-warning fs-12">{campaign.status}</div>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                        ...
                                        <Col xxl={4} lg={6}>
                                            <div className="border rounded border-dashed p-2">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 overflow-hidden">
                                                        <h5 className="fs-13 mb-1"><Link to="#" className="text-body text-truncate d-block">Q8Tasweet admin.ppt</Link></h5>
                                                        <div>2.4MB</div>
                                                    </div>
                                                    <div className="flex-shrink-0 ms-2">
                                                        <div className="d-flex gap-1">
                ...
                <Col xl={3} lg={4}>
                    <Card>
                        <CardHeader className="align-items-center d-flex border-bottom-dashed">
                            ...
                            <h5 className="card-title mb-0 flex-grow-1">Supervisors</h5>
                            <div className="flex-shrink-0">
                                <button type="button" className="btn btn-soft-danger btn-sm" data-bs-toggle="modal" data-bs-target="#inviteMembersModal"><i className="ri-add-line me-1 align-bottom"></i>Add</button>
                            </div>
                        </CardHeader>
                        <CardBody>
                    ...
                    <Card>
                        <CardHeader className="align-items-center d-flex border-bottom-dashed">
                            <h4 className="card-title mb-0 flex-grow-1">Guarantors</h4>
                            <div className="flex-shrink-0">
                                <button type="button" className="btn btn-soft-danger btn-sm" data-bs-toggle="modal" data-bs-target="#inviteMembersModal"><i className="ri-add-line me-1 align-bottom"></i>Add</button>
                            </div>
                        </CardHeader>
