...
import estonia from 'shared/data/estonia.svg.json';
import at from 'shared/data/estonia.svg.json'
        ...
        <React.Fragment>
            <Row>
                <Col className="col-12">
                    <h5 className="text-decoration-underline mb-3 mt-2 pb-3">خرائط ومؤشرات تفاعلية</h5>
                </Col>
            </Row>
