...
import { TableContainer, TableFilters, TableContainerHeader } from "shared/components";
import { usePermission, useFilter } from "shared/hooks";
...
const CommitteesTab = () => {
  ...
  ], [handleCampaignMemberClick, campaignAttendees, campaignGuarantees, campaignElectionCommittees, canChangeConfig, canChangeCampaignSupervisor, campaignMembers, campaignRoles]);
  ...
  // Table Filters
  const { filteredData: campaignCommitteeList, filters, setFilters } = useFilter(campaignElectionCommittees);
