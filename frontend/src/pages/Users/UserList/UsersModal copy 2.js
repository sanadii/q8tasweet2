...
const UserModal = ({ isEdit, setModal, modal, toggle, user }) => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      isActive: Yup.number().integer().required("Status is required"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
        const updatedUser = {
        ...
        <ModalBody className="modal-body">
          <Row className="g-3">
            ...
            <div className="d-flex align-items-center mb-3 pb-2">
                <Label for="name-field" className="form-label pe-3">
                  Username
                </Label>
                <Input
                  id="name-field"
              ...
              <div className="d-flex align-items-center mb-3  pb-2">
                <Label for="firstName-field" className="pe-3 form-label">
                  First Name
                </Label>
                <Input
                  id="firstName-field"
              ...
              <div className="d-flex align-items-center mb-3  pb-2">
                <Label for="lastName-field" className="pe-3 form-label">
                  Last Name
                </Label>
                <Input
                  id="lastName-field"
              ...
              <div className="d-flex align-items-center mb-3  pb-2">
                <Label for="gender-field" className="pe-3 form-label">
                  Gender
                </Label>
                <Input
                  id="gender-field"
              ...
              <div className="d-flex align-items-center mb-3  pb-2">
                <Label for="civil-field" className="pe-3 form-label">
                  Civil ID
                </Label>
                <Input
                  id="civil-field"
              ...
              <div className="d-flex align-items-center mb-3  pb-2">
                <Label for="mobile-field" className="pe-3 form-label">
                  Mobile
                </Label>
                <Input
                  id="mobile-field"
              ...
              <div className="d-flex align-items-center mb-3  pb-2">
                <Label for="twitter-field" className="pe-3 form-label">
                  Twitter
                </Label>
                <Input
                  id="twitter-field"
              ...
              <div className="d-flex align-items-center mb-3  pb-2">
                <Label for="description-field" className="pe-3 form-label">
                  Description
                </Label>
                <Input
            ...
            <Col lg={6}>
              <div>
                <Label for="isActive-field" className="form-label">
                  Is Active
                </Label>
                <Input
                  name="isActive"
            ...
            <Col lg={6}>
              <div>
                <Label for="isStaff-field" className="form-label">
                  Is Staff
                </Label>
                <Input
                  name="isStaff"
                  ...
                  onChange={validation.handleChange}
                  onBlur={validation.handleBlur}
                  value={validation.values.isStaff || ""}
                >
                  <option key="0" value="0">
                    No
                  </option>
                ...
                {validation.touched.isStaff && validation.errors.isStaff ? (
                  <FormFeedback type="invalid">
                    {validation.errors.isStaff}
                  </FormFeedback>
                ) : null}
              </div>
            </Col>
