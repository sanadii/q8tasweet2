...
// --------------- Campaign Guarantees ---------------
// Campaign Attendeees
export const GET_ELECTION_ATTENDEES = "GET_ELECTION_ATTENDEES";
export const GET_ELECTION_ATTENDEES_SUCCESS = "GET_ELECTION_ATTENDEES_SUCCESS";
export const GET_ELECTION_ATTENDEES_FAIL = "GET_ELECTION_ATTENDEES_FAIL";

// Add Campaign Attendeees
export const ADD_NEW_ELECTION_ATTENDEE = "ADD_NEW_ELECTION_ATTENDEE";
export const ADD_NEW_ELECTION_ATTENDEE_SUCCESS = "ADD_NEW_ELECTION_ATTENDEE_SUCCESS";
export const ADD_NEW_ELECTION_ATTENDEE_FAIL = "ADD_NEW_ELECTION_ATTENDEE_FAIL";

// Edit Campaign Attendeees
export const UPDATE_ELECTION_ATTENDEE = "UPDATE_ELECTION_ATTENDEE";
export const UPDATE_ELECTION_ATTENDEE_SUCCESS = "UPDATE_ELECTION_ATTENDEE_SUCCESS";
export const UPDATE_ELECTION_ATTENDEE_FAIL = "UPDATE_ELECTION_ATTENDEE_FAIL";

// Delete Campaign Attendeees
export const DELETE_ELECTION_ATTENDEE = "DELETE_ELECTION_ATTENDEE";
export const DELETE_ELECTION_ATTENDEE_SUCCESS = "DELETE_ELECTION_ATTENDEE_SUCCESS";
export const DELETE_ELECTION_ATTENDEE_FAIL = "DELETE_ELECTION_ATTENDEE_FAIL";

// Campaign Attendeees Details
export const GET_ELECTION_ATTENDEE_DETAILS = "GET_ELECTION_ATTENDEE_DETAILS";
export const GET_ELECTION_ATTENDEE_COUNT = "GET_ELECTION_ATTENDEE_COUNT";
