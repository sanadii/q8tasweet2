...
export const GET_ALL_CAMPAIGN_MEMBERS_SUCCESS = "GET_ALL_CAMPAIGN_MEMBERS_SUCCESS";
export const GET_ALL_CAMPAIGN_MEMBERS_FAIL = "GET_ALL_CAMPAIGN_MEMBERS_FAIL";
export const ADD_CAMPAIGN_MEMBER = "ADD_CAMPAIGN_MEMBER";
export const ADD_CAMPAIGN_MEMBER_SUCCESS = "ADD_CAMPAIGN_MEMBER_SUCCESS";
export const ADD_CAMPAIGN_MEMBER_FAIL = "ADD_CAMPAIGN_MEMBER_FAIL";
export const UPDATE_CAMPAIGN_MEMBER = "UPDATE_CAMPAIGN_MEMBER";
export const UPDATE_CAMPAIGN_MEMBER_SUCCESS = "UPDATE_CAMPAIGN_MEMBER_SUCCESS";
export const UPDATE_CAMPAIGN_MEMBER_FAIL = "UPDATE_CAMPAIGN_MEMBER_FAIL";
>>>>>>> sanad
...
export const ADD_CAMPAIGN_GUARANTEE_SUCCESS = "ADD_CAMPAIGN_GUARANTEE_SUCCESS";
export const ADD_CAMPAIGN_GUARANTEE_FAIL = "ADD_CAMPAIGN_GUARANTEE_FAIL";
export const UPDATE_CAMPAIGN_GUARANTEE = "UPDATE_CAMPAIGN_GUARANTEE";
export const UPDATE_CAMPAIGN_GUARANTEE_SUCCESS = "UPDATE_CAMPAIGN_GUARANTEE_SUCCESS";
export const UPDATE_CAMPAIGN_GUARANTEE_FAIL = "UPDATE_CAMPAIGN_GUARANTEE_FAIL";
export const DELETE_CAMPAIGN_GUARANTEE = "DELETE_CAMPAIGN_GUARANTEE";
...
export const GET_ALL_CAMPAIGN_GUARANTEE_GROUPS = "GET_ALL_CAMPAIGN_GUARANTEE_GROUPS";
export const GET_ALL_CAMPAIGN_GUARANTEE_GROUPS_SUCCESS = "GET_ALL_CAMPAIGN_GUARANTEE_GROUPS_SUCCESS";
export const GET_ALL_CAMPAIGN_GUARANTEE_GROUPS_FAIL = "GET_ALL_CAMPAIGN_GUARANTEE_GROUPS_FAIL";
export const ADD_CAMPAIGN_GUARANTEE_GROUP = "ADD_CAMPAIGN_GUARANTEE_GROUP";
export const ADD_CAMPAIGN_GUARANTEE_GROUP_SUCCESS = "ADD_CAMPAIGN_GUARANTEE_GROUP_SUCCESS";
export const ADD_CAMPAIGN_GUARANTEE_GROUP_FAIL = "ADD_CAMPAIGN_GUARANTEE_GROUP_FAIL";
export const UPDATE_CAMPAIGN_GUARANTEE_GROUP = "UPDATE_CAMPAIGN_GUARANTEE_GROUP";
export const UPDATE_CAMPAIGN_GUARANTEE_GROUP_SUCCESS = "UPDATE_CAMPAIGN_GUARANTEE_GROUP_SUCCESS";
export const UPDATE_CAMPAIGN_GUARANTEE_GROUP_FAIL = "UPDATE_CAMPAIGN_GUARANTEE_GROUP_FAIL";
export const DELETE_CAMPAIGN_GUARANTEE_GROUP = "DELETE_CAMPAIGN_GUARANTEE_GROUP";
export const DELETE_CAMPAIGN_GUARANTEE_GROUP_SUCCESS = "DELETE_CAMPAIGN_GUARANTEE_GROUP_SUCCESS";
export const DELETE_CAMPAIGN_GUARANTEE_GROUP_FAIL = "DELETE_CAMPAIGN_GUARANTEE_GROUP_FAIL";
export const GET_CAMPAIGN_GUARANTEE_GROUP_DETAILS = "GET_CAMPAIGN_GUARANTEE_GROUP_DETAILS";
...
=======
export const ADD_CAMPAIGN_ATTENDEE = "ADD_CAMPAIGN_ATTENDEE";
export const ADD_CAMPAIGN_ATTENDEE_SUCCESS = "ADD_CAMPAIGN_ATTENDEE_SUCCESS";
export const ADD_CAMPAIGN_ATTENDEE_FAIL = "ADD_CAMPAIGN_ATTENDEE_FAIL";
export const UPDATE_CAMPAIGN_ATTENDEE = "UPDATE_CAMPAIGN_ATTENDEE";
export const UPDATE_CAMPAIGN_ATTENDEE_SUCCESS = "UPDATE_CAMPAIGN_ATTENDEE_SUCCESS";
export const UPDATE_CAMPAIGN_ATTENDEE_FAIL = "UPDATE_CAMPAIGN_ATTENDEE_FAIL";
export const DELETE_CAMPAIGN_ATTENDEE = "DELETE_CAMPAIGN_ATTENDEE";
