...
class ElectionsAdmin(admin.ModelAdmin):
    list_display = ['name', 'duedate', 'category', 'sub_category', 'seats', 'votes']
    list_filter = ['category', 'status', 'priority']
    search_fields = ['name', 'description', 'tags', 'type', 'result']
    ordering = ['-duedate', 'name']
    ...
    fieldsets = [
        ('Basic Information', {'fields': ['image', 'name', 'duedate', 'description']}),
