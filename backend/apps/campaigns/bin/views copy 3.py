...
from electors.serializers import VotersSerializer
...
class DeleteCampaignGuarantee(APIView):
    ...
    def delete(self, request, id):
        try:
            ...
            return JsonResponse({"data": "Campaign Guarantee is deleted successfully", "count": 1, "code": 200}, safe=False)
        except CampaignGuarantee.DoesNotExist:
...
class DeleteCampaignAttendee(APIView):
    ...
    def delete(self, request, id):
        try:
            ...
            return Response({"data": "Campaign Attendee is deleted successfully", "count": 1, "code": 200}, status=200)
        except CampaignAttendee.DoesNotExist:
            return Response({"data": "Campaign Attendee not found", "count": 0, "code": 404}, status=404)
