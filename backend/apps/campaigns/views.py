        ...
        return Response(
            {
                "data": {
                    ...
                    "electionDetails": ElectionSerializer(
                        election, context=context
                    ).data,
...
class AddCampaignAttendee(APIView):
    ...
    def post(self, request):
        serializer = CampaignAttendeeSerializer(
...
class UpdateCampaignAttendee(APIView):
    ...
    def patch(self, request, id):
        try:
            ...
            return Response(
                {"data": "Campaign Attendee not found", "count": 0, "code": 404},
                status=404,
            )
...
class DeleteCampaignAttendee(APIView):
    ...
    def delete(self, request, id):
        try:
            ...
            return Response(
                {
                    "data": "Campaign Attendee deleted successfully",
                    "count": 1,
                    "code": 200,
                },
                status=200,
