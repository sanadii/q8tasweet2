...
from backend.apps.campaigns.get_election_details import get_election_details
...
class GetCampaignDetails(APIView):
    ...
    def get(self, request, slug):
        ...
        campaign_members_serialized = (
            CampaignMemberSerializer(campaign_members, many=True, context=context).data,
        )
